...
Config your api_key, api_secret and redrect_uri somewhere like development.rb.
  ...
  ConnectQQ::Config.api_key = "1234567890"
  ConnectQQ::Config.api_secret = "somethinglooksstrageandhardtoremember"
  ConnectQQ::Config.redirect_uri = "http://www.example.com/callback"
...
1.The Authorization Code strategy with response_type set to code
  ...
  # ConnectQQ::Client.from_code is a shortcut for client.auth_code.get_token("authorization_code_value")
  client = ConnectQQ::Client.from_code("authorization_code_value")
...
2.The Authorization Code strategy with response_type set to token
  ...
  client = ConnectQQ::Client.from_hash(:access_token => "6874dd3766b35536abcb76a9e3a57867", :expires_in => 86400)
...
Follow this link to read more about this strategy.{【QQ登录】OAuth2.0开发文档}[http://wiki.opensns.qq.com/wiki/%E3%80%90QQ%E7%99%BB%E5%BD%95%E3%80%91OAuth2.0%E5%BC%80%E5%8F%91%E6%96%87%E6%A1%A3]


  # get token using signed_request
  client = ConnectQQ::Client.from_signed_request("signed_request-posted-by-weibo")
