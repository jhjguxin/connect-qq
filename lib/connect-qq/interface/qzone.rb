  ...
  module Interface
    ...
    class Qzone < Base
      ...
      def public_timeline(opts={})
        get 'statuses/public_timeline', :params => opts.merge(@client.request_params)
      end
      ...
      def friends_timeline(opts={})
        get 'statuses/friends_timeline', :params => opts.merge(@client.request_params)
      end
      ...
      def home_timeline(opts={})
        get 'statuses/home_timeline', :params => opts.merge(@client.request_params)
      end
      ...
      def user_timeline(opts={})
        get 'statuses/user_timeline', :params => opts.merge(@client.request_params)
      end
      ...
      def timeline_batch(opts={})
        get 'statuses/timeline_batch', :params => opts.merge(@client.request_params)
      end
      ...
      def repost_timeline(id, opts={})
        get 'statuses/repost_timeline', :params => {:id => id}.merge(opts).merge(@client.request_params)
      end
      ...
      def repost_by_me(opts={})
        get 'statuses/repost_by_me', :params => opts.merge(@client.request_params)
      end
      ...
      def mentions(opts={})
        get 'statuses/mentions', :params => opts.merge(@client.request_params)
      end
      ...
      def show(id)
        get 'statuses/show', :params => {:id => id}.merge(@client.request_params)
      end
      ...
      def show_batch(ids)
        get 'statuses/show_batch', :params => {:ids => ids}
      end
      ...
      def querymid(id, type=1, opts={})
        get 'statuses/querymid', :params => {:id => id, :type => type}.merge(opts).merge(@client.request_params)
      end
      ...
      def queryid(mid, type=1, opts={})
        get 'statuses/queryid', :params => {:mid => mid, :type => type}.merge(opts).merge(@client.request_params)
      end
      ...
      def hot_repost_daily(opts={})
        get 'statuses/hot/repost_daily', :params => opts.merge(@client.request_params)
      end
      ...
      def hot_repost_weekly(opts={})
        get 'statuses/hot/repost_weekly', :params => opts.merge(@client.request_params)
      end
      ...
      def hot_comments_daily(opts={})
        get 'statuses/hot/comments_daily', :params => opts.merge(@client.request_params)
      end
      ...
      def hot_comments_weekly(opts={})
        get 'statuses/hot/comments_weekly', :params => opts.merge(@client.request_params)
      end
      ...
      def repost(id, opts={})
        post 'statuses/repost', :body => {:id => id}.merge(opts).merge(@client.request_params)
      end
      ...
      def destroy(id)
        post 'statuses/destroy', :body => {:id => id}.merge(@client.request_params)
      end
      ...
      #
      # @see http://wiki.opensns.qq.com/wiki/%E3%80%90QQ%E7%99%BB%E5%BD%95%E3%80%91add_topic
      #add_topic这个api是需要特殊申请的api。
      #你需要发邮件给connect.qq.com申请使用此api。
      #http://wiki.opensns.qq.com/wiki/%E3%80%90QQ%E7%99%BB%E5%BD%95%E3%80%91OpenAPI%E6%9D%83%E9%99%90%E7%94%B3%E8%AF%B7
      def add_topic(con, opts = { format: :json })
        post 'shuoshuo/add_topic', :body => {:con => con}.merge(opts.merge(@client.request_params)), :params => @client.request_params
      end
      
      #add_topic这个api是需要特殊申请的api。
      #你需要发邮件给connect.qq.com申请使用此api。
      #add_share {title: "it's title", url: "https://github.com/jhjguxin", comment: "it's comment", summary: "it's summary"}, {"openid" => 'xxxxxxx',  format: :json, access_token: 'xxxxxxx'}
      def add_share(share = {title: "it's title"},opts = { format: :json })
        post 'share/add_share', :body => share.merge(opts.merge(@client.request_params)), :params => @client.request_params
      end
      ...
      def upload(status, pic, opts={})
        post 'statuses/upload', :body => {:status => status, :pic => pic}.merge(opts), :params => @client.request_params
      end
      ...
      def upload_url_text(opts={})
        post 'statuses/upload_url_text', :body => opts, :params => @client.request_params
      end
      ...
      def emotions(opts={})
        get 'emotions', :params => opts, :params => @client.request_params
      end
    end
  end
end
