...
module ConnectQQ
  ...
  class Client < OAuth2::Client
    ...
    def auth_code
      @auth_code ||= ConnectQQ::Strategy::AuthCode.new(self)
    end
    ...
    def signed_request
      @signed_request ||= ConnectQQ::Strategy::SignedRequest.new(self)
    end
    ...
    def account
      @account ||= ConnectQQ::Interface::Account.new(self)
    end

    def comments
      @comments ||= ConnectQQ::Interface::Comments.new(self)
    end

    def favorites
      @favorites ||= ConnectQQ::Interface::Favorites.new(self)
    end

    def friendships
      @friendships ||= ConnectQQ::Interface::Friendships.new(self)
    end

    def register
      @register ||= ConnectQQ::Interface::Register.new(self)
    end
    ...
    def tags
      @tags ||= ConnectQQ::Interface::Tags.new(self)
    end

    def trends
      @trends ||= ConnectQQ::Interface::Trends.new(self)
    end

    def users

      @users ||= ConnectQQ::Interface::Users.new(self)
    end
  end
end
